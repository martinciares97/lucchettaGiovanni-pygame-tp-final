...
class FormMenuC(Form):
    ...
    def on_click_boton3(self, parametro):
        ...
        angulo_radianes = math.atan2(
            self.graph1.y1 - self.graph1.y0, self.graph1.x1 - self.graph1.x0
        )
        longitud_vector = math.sqrt(
            math.pow(self.graph1.y1 - self.graph1.y0, 2)
            + math.pow(self.graph1.x1 - self.graph1.x0)
        )
    ...
    def calcular(self):
        ...
        longitud_vector = math.sqrt(
            math.pow(self.graph1.y1 - self.graph1.y0, 2)
            + math.pow(self.graph1.x1 - self.graph1.x0, 2)
        )
