...
class Button(Widget):
    ...
    def set_bt_active(self, active):
        if active:
            # Cambiar el estilo del botón cuando está activo
            self.color_background = YELLOW
            self.color_border = YELLOW
        else:
            # Restaurar el estilo del botón cuando no está activo
