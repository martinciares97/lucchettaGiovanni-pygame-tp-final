...
class Enemy:
    def __init__(
        ...
        self.idle_r = Auxiliar.getSurfaceFromSeparateFiles(
            "images/caracters/enemies/ork_sword/IDLE/IDLE_00{0}.png",
            0,
            7,
            scale=p_scale,
        )
        self.idle_l = Auxiliar.getSurfaceFromSeparateFiles(
            "images/caracters/enemies/ork_sword/IDLE/IDLE_00{0}.png",
            0,
            7,
            flip=True,
    ...
    def handle_move(self, delta_ms, plataform_list):
        ...
        if self.tiempo_transcurrido_move >= self.move_rate_ms:
            ...
            if not self.esta_en_la_plataforma(plataform_list):
                if self.move_y == 0:
                    self.is_fall = True
    ...
    def esta_en_la_plataforma(self, plataform_list):
        retorno = False
